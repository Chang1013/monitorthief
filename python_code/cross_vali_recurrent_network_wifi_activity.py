...
# Network Parameters
n_input = 3 # WiFi activity data input (img shape: 90*window_size)
n_steps = window_size # timesteps
n_hidden = 50 # hidden layer num of features original 200
n_classes = 3 # WiFi activity total classes

#n_steps = window_size 
# Output folder
OUTPUT_FOLDER_PATTERN = "LR{0}_BATCHSIZE{1}_NHIDDEN{2}_our_data_butterworth/"
